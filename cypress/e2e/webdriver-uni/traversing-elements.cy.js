...
describe("Traversing DOM elements in Cypress", () => {
  ...
  it("nextUntil() to get all of the next sibling DOM elements within elements until another element (last not included)", () => {
    cy.get("#coffee").nextUntil("#milk").should("have.text", "Tea");
  });
